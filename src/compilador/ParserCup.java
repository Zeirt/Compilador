...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Dec 07 13:11:16 CET 2016
  */
...
public boolean hayErroresFinales(){
	if(hayErrores) return true;
	else {
		if (ParserCup.getScanner().devolverErrores()) return true;
		else return false;
	}
}
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ParserCup$act_num)
		...
		Object b = (Object)((java_cup.runtime.Symbol) CUP$ParserCup$stack.elementAt(CUP$ParserCup$top-1)).value;
			 ...
			 if(hayErroresFinales()) System.err.println("Análisis acabado con errores");
